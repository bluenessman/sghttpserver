...
public class SgServer extends Thread {  
    ...
    public SgServer(File documentRootDirectory,int port , String indexFileName)throws IOException {  
    ...
    private SgServer(File documentRootDirectory, int port)throws IOException {  
...
//            port=Integer.parseInt(args[1]);  
        ...
        try {  
//            SgServer webserver=new SgServer(docroot, port);  
        	SgServer webserver=new SgServer(null, port); 
            webserver.start();  
        } catch (IOException e) {  
